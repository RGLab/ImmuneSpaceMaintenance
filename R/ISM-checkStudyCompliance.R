...
#' @export
checkStudyCompliance = function(reload = FALSE,
                   summarize = TRUE,
                   filterNonGE = TRUE,
                   showAllCols = FALSE,
  ...
  gef <- labkey.selectRows(baseUrl = labkey.url.base,
  ...
  studiesWithGems <- unique(GE_matrices$folder)
  ...
  hai <- labkey.selectRows(baseUrl = labkey.url.base,
                           folderPath = labkey.url.path,
                           schemaName = "study",
                           queryName = "hai")
  nab <- labkey.selectRows(baseUrl = labkey.url.base,
                           folderPath = labkey.url.path,
                           schemaName = "study",
                           queryName = "nab")
  ...
  shareStudies <- grep("SDY\\d+", .listISFiles(folder_link), value = TRUE)
...
.getGEFileNames <- function(rawdata) {
  studies <- .getSdyVec()
